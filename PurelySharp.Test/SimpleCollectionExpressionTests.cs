...
public class CollectionExpressionExample
{
    ...
    public int[] GetArray()
    {
        return [1, 2, 3, 4, 5];
            ...
            await VerifyCS.VerifyAnalyzerAsync(test,
                DiagnosticResult.CompilerError("PMA0001").WithLocation(12, 16).WithArguments("GetArray"));
        }
...
public class CollectionExpressionExample
{
    ...
    public int[] GetModifiedArray()
    {
        ...
        [Test]
        public async Task PureMethod_MutableArrayCollectionExpressionSyntax_Diagnostic_Fixed()
        {
            var test = @"
using System;
using PurelySharp.Attributes;
