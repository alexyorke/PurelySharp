...
//             // Expect diagnostic on the method name
//             var expected = VerifyCS.Diagnostic(PurelySharpDiagnostics.PurityNotVerifiedRule.Id)
//                                    .WithSpan(11, 17, 11, 33) // Span for `IncrementCounter`
...
//             // Expect diagnostic on the method name
//             var expected = VerifyCS.Diagnostic(PurelySharpDiagnostics.PurityNotVerifiedRule.Id)
//                                    .WithSpan(12, 16, 12, 29) // Span for `CombineFields`
...
//             // Expect diagnostic on the method name
//             var expected = VerifyCS.Diagnostic(PurelySharpDiagnostics.PurityNotVerifiedRule.Id)
//                                    .WithSpan(11, 16, 11, 40) // Span for `ReadStaticVolatileField`
...
//             // Expect diagnostic on the method name
//             var expected = VerifyCS.Diagnostic(PurelySharpDiagnostics.PurityNotVerifiedRule.Id)
//                                    .WithSpan(12, 16, 12, 31) // Span for `IncrementAndGet`
...
//             // Expect diagnostic on the method name
//             var expected = VerifyCS.Diagnostic(PurelySharpDiagnostics.PurityNotVerifiedRule.Id)
//                                    .WithSpan(16, 19, 16, 39) // Span for `GetSingletonInstance`
...
//                                     .WithSpan(12, 17, 12, 27) // Span for `Initialize`
//                                     .WithArguments("Initialize");
//
//             // Expect diagnostic on the GetValueIfInitialized method name
//             var expected2 = VerifyCS.Diagnostic(PurelySharpDiagnostics.PurityNotVerifiedRule.Id)
