...
function New-SharpProofGeneratedHeader
{
    param(
    ...
    $header.Add('// <auto-generated>')
    if ([string]::IsNullOrWhiteSpace($Source))
    {
        $header.Add("// Generated by $Generator.")
    }
    else
    {
        $header.Add("// Generated by $Generator from")
        $header.Add("// $Source")
    }
    ...
    $header.Add('// Do not edit this file directly.')
    $header.Add('// </auto-generated>')
    if ($Nullable)
    {
        $header.Add('#nullable enable')
    }
    return ,$header
}
