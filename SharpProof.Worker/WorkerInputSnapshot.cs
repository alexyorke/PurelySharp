    ...
    string apiSpecIdentity, string apiSpecVersion, string apiSpecContentSha256)
{
    ...
    internal static WorkerCacheIdentity Current
    {
        get;
    } = new(
    ...
    {
        return typeof(SharpProofWorker).Assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>()?.InformationalVersion ??
    ...
    {
        return WorkerProtocolJson.IsSha256(value) ? value :
