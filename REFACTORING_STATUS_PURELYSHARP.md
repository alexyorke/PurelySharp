...
- Full analyzer suite is green: `1543/1543` tests in `PurelySharp.Test` targeting .NET 8 with the repo-pinned .NET SDK `9.0.315`.
...
- LINQ `GroupBy` default comparer paths now derive equality purity from the selected key type (`TKey`) instead of the source element type
